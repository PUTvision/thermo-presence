...
class CountMSE(tf.keras.metrics.MeanSquaredError):
    def __init__(self, person_point_weight: float, name: str = 'count_mean_square_error', dtype: tf.dtypes.DType = None):
